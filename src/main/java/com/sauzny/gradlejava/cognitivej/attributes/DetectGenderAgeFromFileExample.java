...
/**
 * *************************************************************************
 * @文件名称: DetectGenderAgeFromFileExample.java
 *
...
public class DetectGenderAgeFromFileExample {
    ...
    public ImageOverlayBuilder apply(String IMAGE_URL) throws IOException {
        ...
        FileUtils.copyURLToFile(new URL(IMAGE_URL), imageFile);
        ...
        .writeGenderAndAge(face, colourPalette, ImageOverlayBuilder.DEFAULT_BORDER_WEIGHT.insets(), RectangleTextPosition.TOP_OF));
