...
package com.sauzny.gradlejava.cognitivej.detect;
...
public class DetectSingleFaceFromFileExample {
    ...
    public ImageOverlayBuilder apply(String IMAGE_URL) throws IOException {
        ...
        return imageOverlayBuilder.outlineFaceOnImage(faceScenarios.findSingleFace(imageFile), RectangleType.FULL);//.launchViewer();
    }
}
