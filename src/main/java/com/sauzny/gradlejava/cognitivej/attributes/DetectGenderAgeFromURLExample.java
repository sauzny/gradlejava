...
/**
 * *************************************************************************
 * @文件名称: DetectGenderAgeFromURLExample.java
 *
...
public class DetectGenderAgeFromURLExample {
    ...
    public ImageOverlayBuilder apply(String IMAGE_URL) throws IOException {
        ...
        Face face = faceScenarios.findSingleFace(IMAGE_URL);
        return imageOverlayBuilder.outlineFaceOnImage(face, RectangleType.FULL, ImageOverlayBuilder.DEFAULT_BORDER_WEIGHT, CognitiveJColourPalette.POPPY).writeGenderAndAge(face, CognitiveJColourPalette.POPPY);//.launchViewer();
    }
}
