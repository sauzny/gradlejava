...
package com.sauzny.gradlejava.cognitivej.verify;
...
public class VerifyFacesFromUrlExample {
    ...
    public ImageOverlayBuilder apply(String IMAGE_URL) throws IOException {
        ...
        return imageOverlayBuilder.verify(CANDIDATE_2, faceScenarios.verifyFaces(CANDIDATE_1, CANDIDATE_2));//.launchViewer();
    }
}
