...
package com.sauzny.gradlejava.cognitivej.identify;
...
import com.sauzny.gradlejava.cognitivej.identify.tools.BlogHelper;
import com.sauzny.gradlejava.cognitivej.identify.tools.ClassTypeAdapter;
import com.sauzny.gradlejava.cognitivej.identify.tools.ClassTypeAdapterFactory;
...
public class IdentifyMultipleFacesExample {
    ...
    public ImageOverlayBuilder apply(String IMAGE_URL) throws IOException {
        ...
        return imageOverlayBuilder;//.launchViewer().toClipboard();
    }
