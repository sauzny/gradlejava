...
/**
 * *************************************************************************
 * @文件名称: DetectFacialLandmarksExample.java
 *
...
public class DetectFacialLandmarksExample {
    ...
    public ImageOverlayBuilder apply(String IMAGE_URL) throws IOException {
        ...
        return ImageOverlayBuilder.builder(IMAGE_URL).outFaceLandmarksOnImage(faces, BorderWeight.THIN);//.launchViewer();
    }
}
